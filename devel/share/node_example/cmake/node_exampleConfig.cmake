...
if(NOT "/home/trin_igvc/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'node_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trin_igvc/catkin_ws/src/node_example/${idir}'.  Ask the maintainer 'Thomas Denewiler <tdenewiler@gmail.com>' to fix it.")
    endif()

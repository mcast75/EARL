...
(cl:in-package image_transport_package-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ResizedImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResizedImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name image_transport_package-msg:<ResizedImage> is deprecated: use image_transport_package-msg:ResizedImage instead.")))

(cl:ensure-generic-function 'original_height-val :lambda-list '(m))
(cl:defmethod original_height-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_transport_package-msg:original_height-val is deprecated.  Use image_transport_package-msg:original_height instead.")
  (original_height m))

(cl:ensure-generic-function 'original_width-val :lambda-list '(m))
(cl:defmethod original_width-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_transport_package-msg:original_width-val is deprecated.  Use image_transport_package-msg:original_width instead.")
  (original_width m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <ResizedImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader image_transport_package-msg:image-val is deprecated.  Use image_transport_package-msg:image instead.")
  (image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ResizedImage>)))
  ...
  "image_transport_package/ResizedImage")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ResizedImage)))
  "Returns string type for a message object of type 'ResizedImage"
  "image_transport_package/ResizedImage")
